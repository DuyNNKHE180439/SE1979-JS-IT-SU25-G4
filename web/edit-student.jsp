            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="edit-student" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="dateOfBirth" id="dateOfBirth" value="${not empty student.user.dateOfBirth ? fn:substring(student.user.dateOfBirth, 0, 10) : ''}" />
                                <small id="dobError" class="text-danger">
                                    <c:if test="${not empty dateError}">${dateError}</c:if>
                                    </small>
                                </div>
                            ...
                            <div class="form-group" id="studentCodeGroup" style="display: none;">
                                ...
                                <small id="studentCodeError" class="text-danger">
